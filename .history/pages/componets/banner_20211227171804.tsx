...
console.log(topmovie)
    ...
    return (
        ...
        backgroundPosition:"center center",
            backgroundImage:`url("${IMG_PATH}${topmovie.results[6].backdrop_path}")`}}
            >
            


          <div className={styles.banner_contents}>
              <h1 className={styles.banner_title}>{topmovie.results[6].title}</h1>
              ...
              <h1 className={styles.banner_description}>
                  {truncate( `${topmovie.results[6].overview}`,150)}</h1>
