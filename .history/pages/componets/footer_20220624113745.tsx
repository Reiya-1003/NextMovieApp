    ...
    <footer className={styles.footer}>
      <div className="mx-56">
        <div className="flex justify-start inline-flex">
          <a className="mr-4" href="https://twitter.com/home?lang=ja">
            <TwitterIcon />
          </a>
          ...
          <a className="mr-4" href="https://www.youtube.com/">
            <YouTubeIcon />
          </a>
        </div>
        <ul className="flex flex-wrap text-gray-400">
          <li className="mb-4 text-xs w-1/4 flex-none p-2">
            副音声・音声ガイド
          </li>
        ...
        <div
          className="text-xs text-gray-400 p-1 mb-5 border divide-solid border-gray-400"
          style={{ marginRight: "90%" }}
        >
          サービスコード
        </div>
        <div className="text-gray-400" style={{ fontSize: "11px" }}>
          ©︎1998-2021 Egamidesu .inc{" "}
        </div>
      </div>
    </footer>
  );
