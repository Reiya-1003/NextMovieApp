    ...
    return (
        ...
        <div className="mx-56 ">
           ...
           <ul className="flex flex-wrap text-gray-400">
            ...
            <div className="text-xs text-gray-400 p-1  border divide-solid border-gray-400" style={{marginRight:"90%"}}>サービスコード</div>
            </div>
            <div className="text-gray-400">©︎1998-2021 Egamidesu .inc </div>
