...
const actionmovie =await fetch(
  `https://api.themoviedb.org/3/discover/movie?api_key=78eb03987f34d05d918381d81d8257fe&with_genres=28`
);
...
const tvmovie =await fetch(
  `https://api.themoviedb.org/3/discover/movie?api_key=78eb03987f34d05d918381d81d8257fe&with_genres=10770`
);
const tvjson = await tvmovie.json();

//ドキュメント２０件
const documovie =await fetch(
  `https://api.themoviedb.org/3/discover/movie?api_key=78eb03987f34d05d918381d81d8257fe&with_genres=99`
);
...
const warmovie =await fetch(
  `https://api.themoviedb.org/3/discover/movie?api_key=78eb03987f34d05d918381d81d8257fe&with_genres=10752`
);
